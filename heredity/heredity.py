...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        if mother is None and father is None:
            ...
            # Calculate the probability based on parents' genes
            ...
            # Probabilities of passing on each gene
            mother_probs = {
                2: 1 - PROBS["mutation"],
                1: 0.5,
                0: PROBS["mutation"]
            ...
            if genes == 2:
                probability *= mother_probs[mother_genes] * father_probs[father_genes]
            elif genes == 1:
                probability *= (mother_probs[mother_genes] * (1 - father_probs[father_genes]) +
                                (1 - mother_probs[mother_genes]) * father_probs[father_genes])
            else:
                probability *= (1 - mother_probs[mother_genes]) * (1 - father_probs[father_genes])

        # Multiply by the probability of having or not having the trait
